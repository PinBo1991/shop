...
<title>部门新增<%--author:高振中,DATE:2014-07-29 16:49:42--%></title>
</head>
<script type="text/javascript">
	function toSave() {//保存记录
		...
		toAction("${webPath}/sysdept/insert");
	}
</script>
<body>
	<form:form id="form1" method="post" commandName="sysdept">
		<div class="ti">部门新增</div>
		...
		<center class="btn_div">
			...
			<input type="button" class="bnt" onclick="toAction('${webPath}/sysdept/list');" value="返回"/>
		</center>
	</form:form>
</body>
<script type="text/javascript">
